...
srun python train.py --train_batch_size 4 --val_check_interval 0.05 --wb_name "bs4-retrain-more-prompts-13B" --gradient_accumulation_steps 2 --learning_rate 0.0003