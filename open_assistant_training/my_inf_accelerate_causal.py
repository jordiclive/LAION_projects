...
def main(ckpt_path='/fsx/home-jordiclive/open_assistant_training/checkpoint-curr-best_20230111_1614',model_name='EleutherAI/pythia-125m-deduped',val_path='val.json',kwargs = dict(
