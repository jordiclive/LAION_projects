...
# Prompts should be formatted with a : at the end and the input to the model should be formatted
#as e.g. "Summarize the following: \n\n  <input text>"
example_prompts = {
    "social": "Produce a short summary of the following social media post:",
    "social2": "Give a 5 word third person summary of the following conversation:",
    "social3": "Give a 50 word third person summary of the following conversation:",
...
def generate(inputs, max_source_length=512, summarization_type=None, prompt=None):
    ...
    if summarization_type is not None:
        inputs = [f"{example_prompts[summarization_type].strip()} \n\n {i.strip()}" for i in inputs]
...
for k in  ["social","social1","social2"]:
    ...
    print('\n')
    _, outputs, _ = generate(inputs, summarization_type=k)
    print(outputs)
...
print('\n-----------\n')
print("Summarize the conversation in less than 8 words:")
print(outputs)
